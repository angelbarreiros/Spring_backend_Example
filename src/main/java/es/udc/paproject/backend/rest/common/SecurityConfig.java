...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                ...
                .antMatchers(HttpMethod.GET, "/billboard/session/*").permitAll()
                .antMatchers(HttpMethod.GET, "/billboard/*").permitAll()
                .antMatchers(HttpMethod.GET, "/billboard/movie/*").permitAll()
